...
const ChequeComment: React.FC<ChequeCommentProps> = ({ 
  authToken, 
  chequeId, 
  userId, 
  onError, 
        ...
        <div className="flex space-x-3 space-x-reverse">
          <div className="flex-1">
            <textarea
              ...
              placeholder="نظر خود را درباره این چک بنویسید..."
